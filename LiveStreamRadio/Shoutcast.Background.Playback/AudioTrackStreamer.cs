...
namespace Shoutcast.Sample.Phone.Background.PlaybackAgent
{
    ...
    public class AudioTrackStreamer : AudioStreamingAgent
    {
        ...
        private static void MetadataChanged(object sender, RoutedEventArgs e)
        {
            ...
            //    var info = AudioTrackStreamer.mss.CurrentMetadata.Title.Split(delimiters, StringSplitOptions.RemoveEmptyEntries);
            //    if (info.Length == 2)
            //    {
            //        track.Artist = info[0].Trim();
            //        track.Title = info[1].Trim();
            //        track.Tag = AudioTrackStreamer.mss.CurrentMetadata.Title;
            //    }
            //    track.EndEdit();
